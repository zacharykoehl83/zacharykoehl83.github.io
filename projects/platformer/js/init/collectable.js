(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 300,);
        collectable.create(type.kennedi, 500, 450, 6, 1.5);
        collectable.create(type.db,800, 600);
        collectable.create(type.max,100, 50 )
